...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        ...
        <div class="playnow">
            <span>play now</span>
            <img class="invert" src="image/playbar.svg" alt="">
        </div>
     </li>`;
    }
        ...
        let response = await a.json()
            ...
            <div class="play">
                <svg width="23" height="23" viewBox="0 0 24 24" fill="none"
                    ...
                    style="background-color: #1fdf64; border-radius: 50%; padding: 4px;">
                    <path d="M5 20V4L19 12L5 20Z" stroke="#000000" fill="#000" stroke-width="1"
